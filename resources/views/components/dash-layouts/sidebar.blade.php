            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('dash.branches.index') }}" class="" aria-expanded="false">
						<div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h18v18H3zM21 9H3M21 15H3M12 3v18"/></svg>						</div>
                    ...
                    <li><a href="{{ route('dash.images.index') }}" class="" aria-expanded="false">
						<div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M20.4 14.5L16 10 4 20"/></svg>					</div>
                    ...
                    <li><a href="{{ route('dash.vouchers.index') }}" class="" aria-expanded="false">
						<div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="20.5" r="1"/><circle cx="18" cy="20.5" r="1"/><path d="M2.5 2.5h3l2.7 12.4a2 2 0 0 0 2 1.6h7.7a2 2 0 0 0 2-1.6l1.6-8.4H7.1"/></svg>				</div>
							<span class="nav-text">Vouchers</span>
						</a>
					</li>
                    @endcan
                    @if(Auth::user()?->can('service_roles')||Auth::user()?->can('service_admins'))
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="mm-collapse">
							<li><a href="{{ route('admin.enterprises.index') }}">Subscriptions</a></li>
							<li><a href="{{ route('admin.enterprise-copones.index') }}">Copones</a></li>
