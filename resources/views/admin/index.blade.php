									...
									<div class="card-body depostit-card p-0">
										<div class="depostit-card-media d-flex justify-content-between pb-0">
											...
											<div class="icon-box bg-danger-light">
												<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
											</div>
										</div>
					...
					<div class="col-xl-12 col-md-12">
						<div class="card">
							<div class="card-header pb-0 border-0">
								<h4 class="heading mb-0">Category Services</h4>
							...
							<div class="card-body">
								...
								<div class="project-date">
									...
									<div class="project-media">
										...
										<span>{{ $category->services->count() }} Servicecs</span>
									</div>
                                    @endforeach
