                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                    <div>
                                        <a class="btn btn-info mx-2 float-end" href="{{ route('admin.partners.branch-create',$service->id) }}">+ Add Branch</a>
                                        <a class="btn btn-info mx-2 float-end" href="{{ route('admin.partners.images-create',$service->id) }}">+ Add Images</a>
                                        <a class="btn btn-info mx-2 float-end" href="{{ route('admin.partners.offer-create',$service->id) }}">+ Add Offer</a>
                                        <a class="btn btn-info mx-2 float-end" href="{{ route('admin.partners.vouchers',$service->id) }}" >{{  __('Vouchers') }}</a>
                                    </div>
