<x-admin-layouts.admin-app>
    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li>
                    <h5 class="bc-title">{{ $service->name }} {{__('Vouchers') }}</h5>
                </li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Vouchers') }}{{ $service->name }} {{__('Vouchers') }}
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="table-responsive active-projects manage-client">
                                        <div class="tbl-caption">
                                            <h4 class="heading mb-0"> {{ $service->name }} {{__('Vouchers') }}</h4>
                                        </div>
