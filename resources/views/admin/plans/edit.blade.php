                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <div class="card-body custom-ekeditor">
                                                <textarea {{-- id="ckeditor" --}} class="form-txtarea form-control" rows="8" name="english_details">{{ old('english_details',$plan->getTranslation('details','en')) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <div class="card-body custom-ekeditor">
                                                <textarea id="ckeditor1" class="form-txtarea form-control" rows="8" name="arabic_details">{{ old('arabic_details',$plan->getTranslation('details','ar')) }}</textarea>
                                            </div>
