    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Add Service images') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Add Service images') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.service-images.index') }}" >{{  __('Service images') }}</a>
        </div>
