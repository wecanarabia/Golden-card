    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Add Promo Code') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Add Promo Code') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Add Promo Code') }}</h4>
                            ...
                            <form method="POST" action="{{ route('admin.promo-codes.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="num_of_users" value="{{ old('num_of_users') }}">
                                        @error('num_of_users')
                                        <div class="text-danger">{{ $message }}</div>
                                         @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" id="fixed" type="radio" name="type" value="fixed" @checked(old('type')=="fixed")>
                                            <label class="form-check-label" for="fixed">
                                                Fixed
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="percentage" type="radio" name="type" value="percentage" @checked(old('type')=="percentage")>
