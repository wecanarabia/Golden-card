    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Slider Image') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Edit Slider Image') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.slider.index') }}" >{{  __('Slider Image') }}</a>
        </div>
