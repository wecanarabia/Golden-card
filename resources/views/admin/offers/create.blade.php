                            ...
                            <form method="POST" action="{{ route("admin.offers.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <select class="default-select form-control wide mb-3" name="service_id" id="service_id" tabindex="null">
                                        ...
                                        <div id="cats-list" class="col-xl-8 mb-3">
                                            ...
                                            <div id="branch_id">
                                                @foreach ($branches as $branch)
                                                    <input type="checkbox" class="form-input" value="{{ $branch->id }}" name="branches[]" @selected(in_array($branch->id,old( 'branches',[])))> {{ $branch->name }}<br>
                                                @endforeach
                                            </div>
                                        @error('branches')
                                        <div class="text-danger">{{ $message }}</div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(branches, function(index, value) {
                            $('#branch_id').append(' <input type="checkbox" class="form-input" name="branches[]" value="' + value.id + '"> ' + value["name"]["en"]+"<br>");
                        });
                    }
                });
            });
