                            ...
                            <form method="POST" action="{{ route("admin.offers.update",$offer->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="discount_value" value="{{ old('discount_value',$offer->discount_value) }}">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="use_times" value="{{ old('use_times',$offer->use_times) }}">
                                            @error('use_times')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="inactive" type="radio" name="status" value="0" @checked(old('status',$offer->status)==0)>
                                                <label class="form-check-label" for="inactive">
                                                    InActive
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" id="active" name="status" value="1" @checked(old('status',$offer->status)==1)>
