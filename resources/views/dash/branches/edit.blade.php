                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body p-0">
                            ...
                            <form method="POST" action="{{ route("dash.branches.update",$branch->slug) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            <label for="exampleFormControlInputsecond" class="form-label">Location-Ar<span class="text-danger">*</span></label>
