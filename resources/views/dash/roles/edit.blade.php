    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Role') }}</h5></li>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Edit Role') }}</h4>

                            <form method="POST" action="{{ route("dash.roles.update",$role->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInputfirst" name="name" placeholder="Name" value="{{ old('name',$role->name) }}">
                                            @error('name')
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="check{{ $name }}" value="{{ $name }}" @checked(is_array(old('permissions',$role->permissions)) && in_array($name,old('permissions',$role->permissions)))>
