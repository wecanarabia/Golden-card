    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Create Offer','today') }}</h5></li>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body p-0">
                            ...
                            <form method="POST" action="{{ route("dash.offers.store") }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="dropdown bootstrap-select show-tick default-select form-control wide">
                                            <select name="tags[]" multiple="" class="default-select form-control wide" tabindex="null">
                                                @foreach ($tags as $tag)
                                                    <option value="{{ $tag->id }}" @selected(in_array($tag->id,(array)old('tags')))>{{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="dropdown bootstrap-select show-tick default-select form-control wide">
                                            <select name="branches[]" multiple="" class="default-select form-control wide" tabindex="null">
                                                @foreach ($branches as $branch)
                                                    <option value="{{ $branch->id }}" @selected(in_array($branch->id,(array)old('branches')))>{{ $branch->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
